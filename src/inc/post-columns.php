...
function namage_custom_column( $colname, $post_id ) {
  ...
  switch ( $colname ) {
    ...
    case 'terms':
      ...
      $terms_text = substr( $terms_text, 0, -2 );
      echo '<p>' . $terms_text . '</p>';
      break;
  }
}
...
add_filter( 'manage_service_posts_columns', 'manage_columns', 4 );

// Заполнение колонок нужными данными
add_action( 'manage_service_posts_custom_column', 'namage_custom_column', 5, 2);